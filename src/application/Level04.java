 ...
 * Items: Acorns, Donuts, Cupcakes (Cassettes coming soon)
 * Boss: Angry Grandma
 */
public class Level04 extends Level{	
    ...
    public String getQuestText() {
        return "Collect 10 acorns, 10 donuts, 10 cupcakes, defeat 20 garlic monsters to battle the Angry Grandma!";
    }
    
    @Override
    public Map<Class<? extends Enemy>, Integer> getEnemyGoals() {
        Map<Class<? extends Enemy>, Integer> goals = new HashMap<>();
        goals.put(EnemySquirrel.class, 0); // Not required for level 4
        goals.put(EnemyPillbug.class, 0); // Not required for level 4
        goals.put(EnemyGarlic.class, 20); // Required for level 4
        return goals;
    }
