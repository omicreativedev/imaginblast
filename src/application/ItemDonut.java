...
// "Pepper! Pepper! There's too much pepper in that soup!" 
...
public class ItemDonut extends Item {
    ...
    /**
     * DONUT ITEM CONSTRUCTOR
     * Creates a new donut item at the specified position
     * 
     * @param posX Initial X coordinate (random across screen width)
     * @param posY Initial Y coordinate (usually 0 at top of screen)
     * @param size Width and height of the donut (square)
     * @param imageView The donut's visual representation
     */
    public ItemDonut(int posX, int posY, int size, ImageView imageView) {
    ...
    /**
     * ON COLLECTED METHOD
     * Called when player collects this donut
     ...
     * Donut-specific falling behavior
    ...
    public void update(GraphicsContext gc) {
        ...
        // FUTURE IDEAS:
        // - Bounce slightly while falling
        // - Spin while falling
        // - Make sound when collected
        // - Give bonus points for donuts
    }
