...
public class GameRenderer {
    ...
    public void drawStartScreen(StartScreen startScreen) {
        ...
        gc.drawImage(logo, ImaginBlastMain.WIDTH/64, ImaginBlastMain.HEIGHT/64 + 75);
       ...
       // gc.fillText("FrogArmy", ImaginBlastMain.WIDTH/2, ImaginBlastMain.HEIGHT/2 - 50);
        ...
        gc.fillText("Instructions: Move your mouse cursor to move, left-click on mouse to shoot!", ImaginBlastMain.WIDTH/2, ImaginBlastMain.HEIGHT/2 + 95);
